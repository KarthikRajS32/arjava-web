...
const Privacy = () => {
  ...
  return (
    <div className="font-sans bg-slate-50 text-slate-800 scroll-smooth">
      ...
      {/* Hero Section */}
      <section className="min-h-[36rem] flex items-center justify-center text-center px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto  reveal opacity-0 translate-y-12 transition-all duration-700 ease-out">
          ...
          <p className="text-base sm:text-base opacity-75">
      ...
      <section className="py-10 sm:py-10 lg:py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-gray-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl reveal opacity-0 translate-y-12">
            <div className="prose max-w-none">
              <h2 className="text-slate-800 font-bold text-xl sm:text-2xl mt-6 sm:mt-8 mb-3 sm:mb-4">
                1. Information We Collect
              </h2>
              <p className="text-slate-500 text-sm sm:text-base leading-relaxed mb-3 sm:mb-4">
                We collect information you provide directly to us, such as when
                you:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-slate-500 text-sm sm:text-base mb-3 sm:mb-4">
              ...
              <h3 className="text-slate-600 font-semibold text-lg sm:text-xl mt-5 sm:mt-6 mb-2 sm:mb-3">
              ...
              <div className="bg-white p-4 sm:p-6 rounded-lg mt-6 shadow-sm">
